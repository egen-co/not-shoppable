...
Ensure that the allowlist for image domains is set to allow `https://www.elfcosmetics.com` for product images, the allowlist for media domains is set to allow `https://fonts.googleapis.com/` for fonts, and that allowlist for URL fetching domains is set to include `wss://irc-ws.chat.twitch.tv:443`, `ws://irc-ws.chat.twitch.tv:80`, `irc://irc.chat.twitch.tv:6667`, `irc://irc.chat.twitch.tv:6697` to allow connecting to chat.
...
Allowlist explanations:
    ...
    - `https://www.elfcosmetics.com` e.l.f. Cosmetics website, for fetching product images
